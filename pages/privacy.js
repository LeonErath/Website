    ...
    <ImpressumBox>
      <Text>
        ...
        <p>
          ...
          of the Leon Erath. The use of the Internet pages of the Leon Erath is
        ...
        <p>
          ...
          the Leon Erath. By means of this data protection declaration, our
        ...
        <p>
          As the controller, the Leon Erath has implemented numerous technical
        ...
        <p>
          Through the use of cookies, the Leon Erath can provide the users of
        ...
        <p>
          The website of the Leon Erath collects a series of general data and
        ...
        <p>
          When using these general data and information, the Leon Erath does not
          ...
          cyber-attack. Therefore, the Leon Erath analyzes anonymously collected
        ...
        <h3>6. Comments function in the blog on the website</h3>
        <p>
          ...
          portal, through which one or more people called bloggers or
        ...
        <p>
          ...
          storage of these personal data is, therefore, in the own interest of
          the data controller, so that he can exculpate in the event of an
          infringement. This collected personal data will not be passed to third
          parties, unless such a transfer is required by law or serves the aim
          of the defense of the data controller.
        </p>
        <h3>7. Subscription to comments in the blog on the website</h3>
        <p>
          The comments made in the blog of the Leon Erath may be subscribed to
        ...
        <p>
          ...
          decided in favor of this option. The option to subscribe to comments
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              wishes to request the erasure of personal data stored by the Leon
              Erath, he or she may, at any time, contact any employee of the
              controller. An employee of Leon Erath shall promptly ensure that
            ...
            <p>
              ...
              far as processing is not required. An employees of the Leon Erath
          ...
          <li>
            ...
            <p>
              ...
              data stored by the Leon Erath, he or she may at any time contact
              any employee of the controller. The employee of the Leon Erath
          ...
          <li>
            ...
            <p>
              ...
              may at any time contact any employee of the Leon Erath.
            </p>
          </li>
          <li>
            ...
            <p>
              The Leon Erath shall no longer process the personal data in the
            ...
            <p>
              ...
              the Leon Erath to the processing for direct marketing purposes,
              the Leon Erath will no longer process the personal data for these
              purposes.
            </p>
            ...
            <p>
              ...
              personal data concerning him or her by the Leon Erath for
          ...
          <li>
            ...
            <p>
              ...
              contact any employee of the Leon Erath.
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          countries use LinkedIn. Thus, LinkedIn is currently the largest
          platform for business contacts and one of the most visited websites in
          the world.
        </p>
        <p>
        ...
        <p>
          ...
          component (LinkedIn plug-in) was integrated, the Internet browser on
          ...
          may be accessed under https://developer.linkedin.com/plugins. During
          the course of this technical procedure, LinkedIn gains knowledge of
        ...
        <p>
          ...
          data subject. If the data subject clicks on one of the LinkedIn
          buttons integrated on our website, then LinkedIn assigns this
          information to the personal LinkedIn user account of the data subject
        ...
        <p>
          ...
          occurs regardless of whether the person clicks on the LinkedIn button
          or not. If such a transmission of information to LinkedIn is not
          desirable for the data subject, then he or she may prevent this by
          logging off from their LinkedIn account before a call-up to our
          website is made.
        </p>
        <p>
          LinkedIn provides under
          https://www.linkedin.com/psettings/guest-controls the possibility to
          unsubscribe from e-mail messages, SMS messages and targeted ads, as
          well as the ability to manage ad settings. LinkedIn also uses
          affiliates such as Eire, Google Analytics, BlueKai, DoubleClick,
          Nielsen, Comscore, Eloqua, and Lotame. The setting of such cookies may
          be denied under https://www.linkedin.com/legal/cookie-policy. The
          applicable privacy policy for LinkedIn is available under
        ...
        <p>
          ...
          with existing business contacts and to create new business contacts.
          The individual users can create a personal profile of themselves at
          XING. Companies may, e.g. create company profiles or publish jobs on
          XING.
        </p>
        <p>
        ...
        <p>
          ...
          under https://dev.xing.com/plugins. During the course of this
          technical procedure, XING gains knowledge of what specific sub-page of
        ...
        <p>
          ...
          information is collected through the XING component and associated
          with the respective XING account of the data subject. If the data
          subject clicks on the XING button integrated on our Internet site,
          e.g. the "Share"-button, then XING assigns this information to the
          personal XING user account of the data subject and stores the personal
          data.
        </p>
        <p>
          XING receives information via the XING component that the data subject
          has visited our website, provided that the data subject is logged in
          at XING at the time of the call to our website. This occurs regardless
          of whether the person clicks on the XING component or not. If such a
        ...
        <h3>12. Legal basis for the processing </h3>
        <p>
        ...
        <h3>16. Existence of automated decision-making</h3>
        <p>
