  ...
  render() {
    return (
      <div>
        ...
        >
          <Card>
            <Card.Image url="url(/static/images/pineapple/encrpytion.png)">
              <Card.Icon src="/static/images/pineapple/encrpytion_icon.png" />
            </Card.Image>
          ...
          <Card>
            <Card.Image url="url(/static/images/pineapple/law.png)">
              <Card.Icon src="/static/images/pineapple/law_icon.png" />
            </Card.Image>
          ...
          <Card>
            <Card.Image url="url(/static/images/pineapple/authentication.png)">
              <Card.Icon src="/static/images/pineapple/authentication_icon.png" />
            </Card.Image>
